                      ...
                      <form action="#" method="post" class="comments-form">
                        <div class="row">
                          <div class="col-md-12">
                            ...
                            <input type="number" name="username" placeholder="Enter Mobile No." required>
                          </div>
						           <div class="clearfix"></div>
                          <div class="col-md-12">
                            <label><i class="fas fa-lock"></i></label>
                            <input id="partitioned" name="login" type="text" style="background-color: #f5f8fa; color: #33475b; font-size:18px; margin-bottom:0px; border: 1px solid #cbd6e2; height:40px;" required="" placeholder="Enter OTP">
                          </div>
